...
1. Read skill path from ./skill/wlb26-test-design-skill (look for SKILL.md)
2. Read eval cases from: ./evals/evals.json
3. Create output dir: ./evals/results/iteration-x/
   (auto-increment x based on existing iteration folders)
...
7. Run: python -m scripts.aggregate_benchmark ./evals/results/iteration-x/
