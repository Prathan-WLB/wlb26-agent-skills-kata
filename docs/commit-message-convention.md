...
- เขียนได้ **กรรทัดเดียว** ขึ้นต้นด้วย `[Tag]` เสมอ
- ระบุ **ชื่อไฟล์ + path** ไว้ใน message
- ระบุ **รายละเอียด** ว่าได้ทำอะไรบ้างทำไม
- เขียน commit message ได้เป็นภาษาไทยหรืออังกฤษก็ได้ แต่ **technical terms ให้ใช้ภาษาอังกฤษ**
...
```
[Edited]: Refactor login test ให้ Page Object Model ย้าย locator และ action เข้าไว้ใน pages/login.page.ts เพื่อลด duplication
```
...
```
[Config]: อัพเดท test data ใน tests/data/products.json เพิ่ม product data ใหม่ 5 รายการตาม requirement ของ Sprint 12
```
...
**ทุก commit ต้องระบุ:** ไฟล์ที่เกี่ยวข้อง + รายละเอียดว่าได้ทำอะไรบ้างทำไม
